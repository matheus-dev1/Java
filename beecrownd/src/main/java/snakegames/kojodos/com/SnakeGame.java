package snakegames.kojodos.com;
...
public class SnakeGame extends JFrame {
     ...
     * Creates a new window, and sets up the controller input.
     */
    private SnakeGame() {
        // Titulo é colocado atraves do metodo super() do JFrame
        super("Jogo da Cobra Releitura por Matheus");
        //
        setLayout(new BorderLayout());
        // Faz algo ao fechar a aplicação, podendo ser por exemplo minimizar ou fechar
        setDefaultCloseOperation(EXIT_ON_CLOSE);
        // Não pode alterar o tamanho da tela
        setResizable(true);
